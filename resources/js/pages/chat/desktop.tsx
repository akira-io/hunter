    ...
    return (
        ...
        >
            ...
            <div className="flex h-full flex-col">
                {/* Chat Header */}
                <div className="fixed left-0 right-0 top-0 z-50 flex items-center gap-3 border-b border-zinc-200 bg-white px-4 py-3 md:left-80 md:px-6 md:py-4 dark:border-zinc-700 dark:bg-zinc-800" style={{ paddingTop: 'max(0.75rem, env(safe-area-inset-top))' }}>
                    {/* Mobile back button */}
                    <button
                ...
                {/* Messages Area */}
                <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-4 md:p-6" style={{ paddingTop: 'calc(env(safe-area-inset-top, 0px) + 64px)' }}>
