...
export function useHuntImageProcessing(
    setHunts: Dispatch<SetStateAction<Hunt[]>>,
) {
    const echo = useEchoPublic<HuntImageProcessedEvent>(
        'hunts',
        undefined,
        undefined,
        [],
    ...
    useEffect(() => {
        ...
        console.log(
            'Listening for hunt image processed events on hunts channel',
        );

        channel.listen(
            '.hunt.image.processed',
            (event: HuntImageProcessedEvent) => {
                        ...
                        if (hunt.id === event.hunt.id) {
                            ...
                            return {
                                ...
                                image_processing_status:
                                    event.hunt.image_processing_status,
                            };
                        }
                        return hunt;
                    });
