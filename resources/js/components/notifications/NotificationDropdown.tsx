...
export const NotificationDropdown: React.FC<NotificationDropdownProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <div
                ref={dropdownRef}
                className="fixed inset-0 z-50 flex flex-col bg-white dark:bg-zinc-800 sm:absolute sm:inset-auto sm:left-auto sm:right-0 sm:top-12 sm:w-96 sm:rounded-lg sm:border sm:border-zinc-200 sm:shadow-lg sm:dark:border-zinc-700"
            ...
            <div className="flex shrink-0 items-center justify-between border-b border-zinc-200 px-4 py-3 pt-12 sm:p-4 sm:pt-4 dark:border-zinc-700">
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900 dark:text-zinc-100">Notificações</h3>
                        ...
                        {unreadNotifications.map((notification) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="p-3 sm:p-4 transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-700/50 bg-blue-50/50 dark:bg-blue-900/10"
                                    ...
                                    <div className="flex items-start gap-2 sm:gap-3">
                                        ...
                                        >
                                            {follower?.avatar_url ? (
                                                <img
                                                    ...
                                                    alt={followerName}
                                                    className="h-10 w-10 sm:h-8 sm:w-8 rounded-full object-cover transition-opacity hover:opacity-80"
                                                />
                                            ) : (
                                                <div className="grid h-10 w-10 sm:h-8 sm:w-8 place-items-center rounded-full bg-gradient-to-br from-zinc-200 to-zinc-300 dark:from-zinc-700 dark:to-zinc-600 transition-opacity hover:opacity-80">
                                                    <UserIcon size={16} className="text-zinc-600 dark:text-zinc-300 sm:size-[14px]" />
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                <h4 className="text-sm sm:text-sm font-medium text-zinc-900 dark:text-zinc-100 leading-tight">
                                                    {notification.title}
                                                </h4>
