    ...
    return (
        <Card className={`${bgColor} border-none`}>
            <CardContent className="flex items-center gap-3 p-4 sm:gap-4 sm:p-6">
                <div
                    className={`rounded-full ${color} bg-white/10 p-2 sm:p-3 dark:bg-black/10`}
                >
                    {icon}
                </div>
...
function RateCard({ label, value, icon, color }: RateCardProps) {
    return (
        <div className="flex items-center justify-between rounded-lg bg-muted/50 p-3 sm:p-4">
            ...
            <span className="ml-2 flex-shrink-0 text-base font-bold sm:text-lg">
                {value}
            </span>
        </div>
    );
                    ...
                    <CardContent className="p-4 sm:p-6">
                        <div className="flex items-start gap-3 sm:items-center sm:gap-4">
                            <div className="flex-shrink-0 rounded-full bg-purple-500/10 p-3 sm:p-4">
                                <Zap
                                    size={24}
                                    className="animate-pulse text-purple-500 sm:h-8 sm:w-8"
                                />
                            </div>
                            <div className="min-w-0 flex-1">
                                <h3 className="mb-1 text-base font-bold text-purple-500 sm:text-xl">
                                    🔥 Conteúdo Viral!
                                </h3>
                                <p className="text-xs text-muted-foreground sm:text-sm">
                                    Este hunt está com performance excepcional!
                                    Continue criando conteúdo de qualidade para
            ...
            <Card className="gradient border-2">
                <CardHeader className="pb-3 sm:pb-6">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <CardTitle className="flex items-center gap-2 text-lg sm:text-xl">
                            <Activity
                                size={20}
                                className="text-purple-500 sm:h-6 sm:w-6"
                            />
                ...
                <CardContent>
                    <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
                        ...
                        <MetricCard
                            icon={
                                <Repeat2 size={20} className="sm:h-6 sm:w-6" />
                            }
                            label="Partilhas"
                    ...
                    <CardContent className="space-y-3 sm:space-y-4">
                        <div className="space-y-2">
                            <div className="flex items-center justify-between gap-2">
                                ...
                                <span className="text-xl font-bold text-purple-500 sm:text-2xl">
                                    {metrics.quality_score.toFixed(1)}/100
                                </span>
                            </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between gap-2">
                                ...
                                <span className="flex-shrink-0 text-lg font-bold sm:text-xl">
                                    {(
                                        metrics.virality_coefficient * 100
                                    ).toFixed(1)}
                                    %
                                </span>
                            </div>
                            <div className="h-2 w-full overflow-hidden rounded-full bg-muted sm:h-3">
                                <div
                                    ...
                                    style={{
                                        width: `${Math.min(metrics.virality_coefficient * 100, 100)}%`,
                                    }}
                                />
                            </div>
                        </div>

                        <div className="flex items-center justify-between gap-2 rounded-lg bg-muted/50 p-3 sm:p-4">
                            <span className="truncate text-xs text-muted-foreground sm:text-sm">
                                Engaj. Médio/View
                            </span>
                            <span className="flex-shrink-0 text-base font-bold sm:text-lg">
                                {metrics.avg_engagement_per_view.toFixed(2)}
                            </span>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-4 sm:p-6">
                        <div className="flex items-start gap-3 sm:items-center sm:gap-4">
                            <div className="flex-shrink-0 rounded-full bg-green-500/10 p-3 sm:p-4">
                                <TrendingUp
                                    size={24}
                                    className="text-green-500 sm:h-8 sm:w-8"
                                />
                            </div>
                            <div className="min-w-0 flex-1">
                                <h3 className="mb-1 text-base font-bold text-green-500 sm:text-xl">
                                    ✨ Ótima Performance!
                                </h3>
                                <p className="text-xs text-muted-foreground sm:text-sm">
                                    Este hunt está performando bem! Continue
                                    assim para aumentar ainda mais o alcance.
                                </p>
                            </div>
                        </div>
                    </CardContent>
